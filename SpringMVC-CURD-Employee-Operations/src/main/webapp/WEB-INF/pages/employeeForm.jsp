            ...
            <div class="panel-body">
                <form:form id="employeeRegisterForm" cssClass="form-horizontal" modelAttribute="employee" method="post" action="saveEmployee">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="control-label col-xs-3"><form:label path="location">Location</form:label></div>
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" path="location" value="${employeeObject.location}"/>
                        </div>
                    </div>
                    
                     <div class="form-group">
                        <div class="control-label col-xs-3"><form:label path="designation">designation</form:label></div>
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" path="designation" value="${employeeObject.designation}"/>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <div class="control-label col-xs-3"><form:label path="company">company</form:label></div>
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" path="company" value="${employeeObject.company}"/>
                        </div>
                    </div>
